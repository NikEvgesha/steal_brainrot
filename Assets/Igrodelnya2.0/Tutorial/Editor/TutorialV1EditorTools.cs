...
public static class TutorialV1EditorTools
{
    ...
    private static readonly Dictionary<string, string[]> V2Translations = new(StringComparer.Ordinal)
    {
        ...
        ["UI/Tutorial/Step/feed_big_pet/Desktop"] = new[] { "Купи фрукт и покорми им большое животное. Задание завершится после кормления. Поздние уровни дают особенно большой бонус дохода.", "Buy a fruit and feed it to the big animal. The task completes after feeding. Late levels unlock an especially large income bonus." },
        ["UI/Tutorial/Step/feed_big_pet/Touch"] = new[] { "Купи фрукт и покорми им большое животное. Задание завершится после кормления. Поздние уровни дают особенно большой бонус дохода.", "Buy a fruit and feed it to the big animal. The task completes after feeding. Late levels unlock an especially large income bonus." },
        ...
        ["UI/Tutorial/Context/SaveFood"] = new[] { "Накопи {0} монет на первый фрукт ({1}/{0}). Затем купи его и покорми большое животное.", "Save {0} coins for the first fruit ({1}/{0}). Then buy it and feed the big animal." },
        ["UI/Tutorial/Context/TravelFoodShop"] = new[] { "Отправляйся в магазин еды — можно использовать телепорт «Еда». Купи фрукт, затем покорми им большое животное.", "Go to the food shop — you can use the FOOD teleport. Buy a fruit, then feed it to the big animal." },
        ["UI/Tutorial/Context/BuyFoodAction"] = new[] { "Купи первый фрукт за {0} монет, затем отнеси его большому животному.", "Buy the first fruit for {0} coins, then bring it to the big animal." },
        ["UI/Tutorial/Context/OpenInventoryFood"] = new[] { "Открой инвентарь и возьми фрукт, чтобы покормить большое животное.", "Open the inventory and take the fruit to feed the big animal." },
        ["UI/Tutorial/Context/ChooseFoodTab"] = new[] { "Открой вкладку «Еда» и выбери фрукт для кормления.", "Choose the Food tab and select a fruit for feeding." },
        ["UI/Tutorial/Context/AddFoodQuick"] = new[] { "Нажми на фрукт, чтобы добавить его в быстрый доступ для кормления.", "Tap the fruit to add it to quick access for feeding." },
        ["UI/Tutorial/Context/EquipFood"] = new[] { "Выбери фрукт на панели быстрого доступа и отнеси его большому животному.", "Select the fruit in quick access and bring it to the big animal." },
        ...
        ["UI/Tutorial/Context/ApproachBigPetWithFood"] = new[] { "Отнеси фрукт большому животному и покорми его.", "Bring the fruit to the big animal and feed it." },
        ["UI/Tutorial/Context/FeedAction"] = new[] { "Покорми большое животное фруктом. После кормления задание завершится. Поздние уровни дают особенно большой бонус дохода.", "Feed the fruit to the big animal. The task completes after feeding. Late levels give an especially large income bonus." },
